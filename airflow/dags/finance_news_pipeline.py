...
import pendulum
from tasks.ingestion.fetch_finance_news import collect_news_to_bronze1
...
default_args = {
    ...
    "retries": 10,                       # mỗi task retry 10 lần
    "retry_delay": timedelta(minutes=3), # mỗi 3 phút
}
...
with DAG(
    ...
    collect_news_task = PythonOperator(
        task_id="collect_finance_news_to_minio",
        python_callable=collect_news_to_bronze1,
